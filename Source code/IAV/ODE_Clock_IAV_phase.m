...
%     dydt(16) = FracNoInf(K_REV_V, K_REV_V + REV) * gamma * I2 - T_E / (T_E + 150) *  d_V * V - d_Vs * V / (K_V + V);
    ...
    dydt(19) = FracNoInf(K_BMAL1_IL1b, K_BMAL1_IL1b + CLOCK_BMAL1) * FracNoInf(K_IL10_IL1b, K_IL10_IL1b + IL10) * c_M_IL1b * Mono + ...
...
%         FracNoInf(K_REV_CCL2, K_REV_CCL2 + REV) * c_I_CCL2 * I2 - d_CCL2 * CCL2;
    dydt(21) = FracNoInf(K_BMAL1_CCL2, K_BMAL1_CCL2 + CLOCK_BMAL1) * FracNoInf(K_IL10_CCL2, K_IL10_CCL2 + IL10) * c_M_CCL2 * Mono + ...
